...
public class Main extends ApplicationAdapter {
	...
	public void ballMovement() {
		...
		cueBall.setY((int) (cueBall.getY() + cueBall.getyVel()));
		cueBall.setX((int) (cueBall.getX() + cueBall.getxVel()));
		...
		if (Math.abs(cueBall.getxVel()) < 0.1f) {
			cueBall.setxVel(0);
		}
		if (Math.abs(cueBall.getyVel()) < 0.1f) {
			cueBall.setyVel(0);
		}
